...
1. **Copy** all the E-Prime Merged data files over to SharePoint:
    ...
    Georgia Institute of Technology / Engle Lab - Documents / Data Collection / [Study Name] / **Data Files / Raw Data / <span style="color: IndianRed">Merged</span>**

2. **Open** an E-Merged data file

3. Go to File **<span style="color: IndianRed"> -> </span>** Export...
...
6. **Save** with the same file name and location as the E-Merge file
    ...
    **Data Files / <span style="color: IndianRed">Merged</span>**
